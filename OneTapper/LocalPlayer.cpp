...
{
	static uint32_t cliendModule = (uint32_t)(GetModuleHandle(L"client.dll"));
	static LocalPlayer* localPlayer = (LocalPlayer*)(cliendModule + hazedumper::signatures::dwLocalPlayer);
